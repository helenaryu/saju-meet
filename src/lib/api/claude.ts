...
export class ClaudeService {
  ...
  private buildAdvancedPrompt(
    ...
    return `
당신은 30년 경력의 전문 관상학자이자 사주 전문가입니다. 
전통 문헌과 현대 심리학을 결합하여 개인화된 연애 성향 분석을 제공합니다.
...
## 분석 요청사항
다음 형식으로 상세하고 전문적인 분석을 제공해주세요:

### 1. 연애 스타일 분석
- 전통 관상학과 사주 이론을 바탕으로 한 연애 성향
- 감정 표현 방식과 파트너와의 소통 스타일
- 사랑에 대한 기본적인 태도와 접근법
...
### 7. 전통 지혜 활용
- 위에서 제공된 전통 문헌의 내용을 적극 활용
- 현대적 해석과 함께 전통적 관점 제시

## 응답 형식
각 섹션은 구체적이고 실용적인 내용으로 작성하되, 
전통 관상학과 사주 이론의 전문성을 유지하면서도 
현대인들이 이해하기 쉽게 설명해주세요.

${conversationContext}

이전 대화의 맥락을 고려하여 연속성 있는 분석을 제공해주세요.
`;
  }
  ...
  private generateDummyResponse(request: ClaudeAnalysisRequest): ClaudeAnalysisResponse {
    return {
      ...
      detailedAnalysis: {
        personalityInsights: '전체적으로 균형잡힌 성격으로 다양한 상황에 잘 적응하는 편입니다.',
        relationshipAdvice: '자연스러운 소통을 통해 상대방을 이해하려고 노력하세요.',
        compatibilityFactors: '감정적 교감과 지적 성장을 중시하는 파트너와 잘 맞습니다.',
        growthOpportunities: '새로운 경험을 통해 더욱 풍부한 연애 경험을 쌓을 수 있습니다.'
      },
      traditionalWisdom: []
    };
  }
