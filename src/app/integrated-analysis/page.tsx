...
export default function IntegratedAnalysisPage() {
  ...
  const startIntegratedAnalysis = async () => {
    ...
    try {
      ...
      // 오행 데이터 설정 (클로드 분석 결과에 맞게)
      setOhaengData({
        labels: ["목(木)", "화(火)", "토(土)", "금(金)", "수(水)"],
        data: [0, 67, 0, 0, 33], // 클로드 분석 결과
        descriptions: [
          "목의 기운이 약하지만 성장 잠재력을 가지고 있어요.",
          "화의 기운이 매우 강해 열정적이고 활발한 성향이에요.",
          "토의 기운이 약하지만 안정성을 추구하는 면이 있어요.",
          "금의 기운이 약하지만 이성적 판단력을 가지고 있어요.",
          "수의 기운이 적당해 유연하고 적응력이 좋아요."
        ],
        personalTraits: [
          "꾸준한 성장을 통해 발전해나가는 타입이에요.",
          "강한 열정으로 목표를 향해 나아가는 리더형이에요.",
          "신중하고 안정적인 관계를 추구해요.",
          "논리적이고 체계적인 사고를 가지고 있어요.",
          "상황에 맞게 유연하게 대처하는 능력이 뛰어나요."
        ],
        colors: ["#A8D5BA", "#FFB4A2", "#FFEAA7", "#B5B2C2", "#AED9E0"],
        overallInterpretation: "화의 기운이 강하고 수의 기운이 보완되어 열정적이면서도 유연한 성향을 가지고 있습니다."
      })
