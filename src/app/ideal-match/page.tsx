          ...
          {dummyMatches.map((match, index) => (
            <div key={index} className="bg-white/10 rounded-2xl p-6 border border-white/20">
              ...
              <div className="flex gap-3 mt-4">
                <button className="flex-1 bg-gradient-to-r from-pink-400 to-purple-500 hover:from-pink-500 hover:to-purple-600 text-white px-4 py-2 rounded-full text-sm font-semibold transition-colors">
                  💬 대화 시작하기
                </button>
                <button className="flex-1 bg-white/20 hover:bg-white/30 text-white px-4 py-2 rounded-full text-sm font-semibold transition-colors border border-white/30">
                  👁️ 프로필 보기
                </button>
              </div>
            </div>
